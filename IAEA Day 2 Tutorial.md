...
:arrow_right: Click **Activate classification preview pointer** in the **SCP Toolbar**. Optionally, adjust the preview size and/or transparency using the adjactent icons on on the **SCP toolbar**.
...
<img src="https://drive.google.com/uc?export=view&amp;id=1ikeHL5YmfJN-j5_Tn6O6g83LHCompP94" alt="classification" style="zoom:50%;" />
